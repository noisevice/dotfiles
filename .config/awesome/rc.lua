...
--naughty.config.defaults.string = ""
...
beautiful.init("/home/user/.config/awesome/themes/custom/theme.lua")
...
myawesomemenu = {
   -- Add menu action to toggle the titlebars
   { "toggle titlebars", function() toggle_titlebars() end },
...
awful.rules.rules = {
    ...
    { rule = { },
      properties = { border_width = beautiful.border_width,
                     ...
                     -----------------------------------------------
                     -- Place new windows in non-retarded location
                     -----------------------------------------------
...
client.connect_signal("request::titlebars", function(c)
    ...
    ------------------------------------------
    -- Handle titlebars upon window creation
    ------------------------------------------

    -- If titlebars are disabled, hide them after creating
...
for s = 1, screen.count() do
    screen[s]:connect_signal("arrange", function ()
        ...
        for _, c in pairs(clients) do
          ...
          -- No border
          if titlebars_enabled or awful.rules.match(c, {class = "Plank"}) or awful.rules.match(c, {class = "Firefox"}) or awful.rules.match(c, {class = "Nautilus"}) then                                     
              c.border_width = 0
          end
...
-- Run init script
--------------------
awful.spawn("sh /home/user/.xinitrc")

-------------------------
-- Round window borders
-------------------------
...
local function apply_shape(draw, shape, ...)
  ...
  local img = cairo.ImageSurface(cairo.Format.A8, geo.width, geo.height)
  local cr = cairo.Context(img)

  cr:set_antialias(ANTIALIAS_GRAY)
  cr:set_fill_rule(FILL_RULE_WINDING)
